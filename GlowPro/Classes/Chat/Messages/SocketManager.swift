...
let _observerDeleteMessage             = "observerDeleteMessage"
let _observerGetLocation              = "observerGetLocation"
let _observerUpdateLocation              = "observerGetLocation"
...
extension SocketManager {
    ...
    func addChatObservers() {
        ...
        socket.on("deleteMessage") { (data, ack) in
            if let  arr = data as? [NSDictionary], !arr.isEmpty, let dict = arr.first{
                print(dict)
            }
        }
...
extension SocketManager {
    ...
    func deleteMessage(messageId : String){
        ...
        let param : [String:Any] = ["message_id" : messageId,"token": "\(_appDelegator.getAuthorizationToken()!)"]
