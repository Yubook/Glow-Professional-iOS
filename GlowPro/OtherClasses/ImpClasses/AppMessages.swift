...
let kInvalidVanNumber       = "Enter valid Van Number"
...
let kSelectedServices = "Please Select At least One Services & Enter Price"
let kSelectedTime = "Please Select At least One Time"
